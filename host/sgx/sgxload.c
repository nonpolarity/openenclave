...
//        // insert breakpoints (int 3 instruction). Note: PROT_WRITE means
//        enable
//        // page write.
//        outflags |= PROT_WRITE;
//    }
...
//    {
//        OE_TRACE_ERROR("VirtualAlloc failed enclave_size=0x%lx",
//        enclave_size); goto done;
//    }
//
// done:
//
...
//            (uint8_t*)addr >
//                (uint8_t*)context->sim.addr + context->sim.size -
//                OE_PAGE_SIZE)
//            OE_RAISE_MSG(
...
//    else
//    {
//        int protect = _make_memory_protect_param(flags, false /*not
//        simulate*/); if (!extend)
