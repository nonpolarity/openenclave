...
bool use_debug_malloc = true;

// Enable/disable debug malloc
void oe_debug_malloc_switch(bool option)
{
    use_debug_malloc = option;
}

bool use_debug_malloc_memset = true;

// Enable/disable memset for debug malloc
void oe_debug_malloc_memset_switch(bool option)
{
    use_debug_malloc_memset = option;
}
